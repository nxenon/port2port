        ...
        try :
            while True :
                ...
                if not client_data :
                    ...
                    break
                try:
                    final_data = (self.commit_client_service_filters(data=client_data.decode() ,_from='client')).encode()
                except:
        ...
        try :
            while True :
                ...
                if not remote_data :
                    ...
                    break
                try :
                    final_data = (self.commit_client_service_filters(data=remote_data.decode() ,_from='remote')).encode()
                except :
